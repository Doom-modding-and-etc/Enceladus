...
int render::clip_bounding_box(MATRIX local_clip, VECTOR *bounding_box)
{
    int ret;
...
void render::RotTransPersClipGsColN(vertex_f_t *output, MATRIX local_screen, VECTOR *verts, VECTOR *normals,
...
void render::calculate_vertices_no_clip(VECTOR *output,  int count, VECTOR *vertices, MATRIX local_screen) {
	asm __volatile__ (
...
void render::calculate_vertices_clipped(VECTOR *output,  int count, VECTOR *vertices, MATRIX local_screen) {
	asm __volatile__ (
	"lqc2		$vf1, 0x00(%3)	    \n"	//set local_screen matrix[0]
	"lqc2		$vf2, 0x10(%3)	    \n"	//set local_screen matrix[1]
	"lqc2		$vf3, 0x20(%3)	    \n"	//set local_screen matrix[2]
...
int render::draw_convert_rgbq(color_t *output, int count, vertex_f_t *vertices, color_f_t *colours, unsigned char alpha)
{
...
int render::draw_convert_rgbaq(color_t *output, int count, vertex_f_t *vertices, color_f_t *colours)
{
...
int render::draw_convert_st(texel_t *output, int count, vertex_f_t *vertices, texel_f_t *coords)
{
...
int render::draw_convert_xyz(xyz_t *output, float x, float y, int z, int count, vertex_f_t *vertices)
{
