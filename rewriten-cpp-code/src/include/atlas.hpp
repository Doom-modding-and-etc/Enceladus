 ...
 ********************************************************************
 ********************************************************************/
 atlas_t *New(size_t width, size_t height, u8 psm);

 /// Frees the atlas
 void Free(atlas_t *atlas);
 ...
 **********************************************************/
 struct atlas_allocation_t *Place(atlas_t *atlas, size_t width, size_t height, const void *surface);
};
